...
params = [
    {"pairs": 1, "bandwidth": 2500, "delay": 40, "buffer": 25, "timeout": 40+2*MSL},
    {"pairs": 1, "bandwidth": 2000, "delay": 80, "buffer": 40, "timeout": 40+2*MSL},
    {"pairs": 1, "bandwidth": 800, "delay": 125, "buffer": 25, "timeout": 40+2*MSL},
    {"pairs": 1, "bandwidth": 10000, "delay": 22, "buffer": 55, "timeout": 40+2*MSL},
    {"pairs": 1, "bandwidth": 15000, "delay": 20, "buffer": 75, "timeout": 40+2*MSL},
    {"pairs": 2, "bandwidth": 2500, "delay": 40, "buffer": 25, "timeout": 2*fairTestTime+4},
    {"pairs": 2, "bandwidth": 2000, "delay": 80, "buffer": 40, "timeout": 2*fairTestTime+4},
    {"pairs": 2, "bandwidth": 800, "delay": 125, "buffer": 25, "timeout": 2*fairTestTime+4},
